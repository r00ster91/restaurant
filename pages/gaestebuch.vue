<template>
  <section>
    ...
    <div v-for="entry, index of guestbook" class="container">
      <br>
      <div class="notification is-primary" style="background-image: linear-gradient(#C850C0 46%, #4158D0 100%); border: 3px solid #FFCC70;">
      ...
      methods: {
        update_storage() {
          ...
          try {
            ...
            this.$buefy.notification.open('Entschuldigung, da ist etwas schiefgelaufen.')
            return false
          }
          return true
        },
        ...
        submit() {
          ...
          if(this.update_storage()) {
            this.$buefy.notification.open('Vielen Dank. Ihre Nachricht wurde erfolgreich gespeichert.')
          }
        }
      }
    }
